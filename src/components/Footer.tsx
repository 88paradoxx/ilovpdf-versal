        ...
        <div className="col-span-2 lg:col-span-2 space-y-8">
          ...
          <div className="flex items-center gap-3">
            {[Twitter, Github, Linkedin, Dribbble].map((Icon, i) => (
              <a key={i} href="#" className="p-3 bg-white/5 hover:bg-white/10 rounded-xl text-slate-400 hover:text-white hover:scale-110 transition-all border border-white/5 hover:border-purple-500/30 group">
